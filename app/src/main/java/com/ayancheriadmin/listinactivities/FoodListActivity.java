...
public class FoodListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        businessDataBase = CusUtils.getDatabase().getReference().child("FoodList");
        buisnessCategoryDB = CusUtils.getDatabase().getReference().child("Food");
...
//                }
                ...
                try {
                    startActivityForResult(builder.build(FoodListActivity.this), PLACE_PICKER_REQUEST);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name_string.length()== 0){
                    Toast.makeText(FoodListActivity.this, "Please Enter A Name", Toast.LENGTH_SHORT).show();
                }
                else {
                        ...
                        businessDataBase.child(new BuisnessCategory(categorySpinner.getSelectedItem().toString()).link).push().setValue(b).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(FoodListActivity.this, "Completed Adding", Toast.LENGTH_SHORT).show();
                                    current_count ++;
                                    name.setText("");
                                    phonenumber.setText("");
                                    address.setText("");
                                    ...
                                    Toast.makeText(FoodListActivity.this, "Some Error Has Happened", Toast.LENGTH_SHORT).show();
                                }
