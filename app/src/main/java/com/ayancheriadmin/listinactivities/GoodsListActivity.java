...
public class GoodsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReferece = CusUtils.getDatabase().getReference().child("Goods");
                    ...
                    databaseReferece.push().setValue(new BloodDonor(nam,donornumber.getText().toString())).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(GoodsListActivity.this, "Success", Toast.LENGTH_SHORT).show();
                                donorname.setText("");
                                donornumber.setText("");
                            }
                            else{
                                Toast.makeText(GoodsListActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                else{
                    Toast.makeText(GoodsListActivity.this, "Enter Name", Toast.LENGTH_SHORT).show();
                }
            }
        });
