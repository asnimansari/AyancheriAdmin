...
public class BuisnessListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buisness_list);
        businessDataBase = CusUtils.getDatabase().getReference().child("BusinessList");
        buisnessCategoryDB = CusUtils.getDatabase().getReference().child("Business");
...
//                }
                ...
                try {
                    startActivityForResult(builder.build(BuisnessListActivity.this), PLACE_PICKER_REQUEST);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name_string.length()== 0){
                    Toast.makeText(BuisnessListActivity.this, "Please Enter A Name", Toast.LENGTH_SHORT).show();
                }
                else {
                        ...
                        businessDataBase.child(new BuisnessCategory(categorySpinner.getSelectedItem().toString()).link).push().setValue(b).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(BuisnessListActivity.this, "Completed Adding", Toast.LENGTH_SHORT).show();
                                    current_count ++;
                                    name.setText("");
                                    phonenumber.setText("");
                                    address.setText("");
                                    ...
                                    Toast.makeText(BuisnessListActivity.this, "Some Error Has Happened", Toast.LENGTH_SHORT).show();
                                }
