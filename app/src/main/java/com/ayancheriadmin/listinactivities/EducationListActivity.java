...
public class EducationListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        businessDataBase = CusUtils.getDatabase().getReference().child("EducationList");
        buisnessCategoryDB = CusUtils.getDatabase().getReference().child("Education");
...
//                }
                ...
                try {
                    startActivityForResult(builder.build(EducationListActivity.this), PLACE_PICKER_REQUEST);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name_string.length()== 0){
                    Toast.makeText(EducationListActivity.this, "Please Enter A Name", Toast.LENGTH_SHORT).show();
                }
                else {
                        ...
                        businessDataBase.child(new BuisnessCategory(categorySpinner.getSelectedItem().toString()).link).push().setValue(b).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(EducationListActivity.this, "Completed Adding", Toast.LENGTH_SHORT).show();
                                    current_count ++;
                                    name.setText("");
                                    phonenumber.setText("");
                                    address.setText("");
                                    ...
                                    Toast.makeText(EducationListActivity.this, "Some Error Has Happened", Toast.LENGTH_SHORT).show();
                                }
