...
public class MedicalCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = CusUtils.getDatabase().getReference().child("Medical");
                    ...
                    databaseReference.push().setValue(buisnessCategory).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(MedicalCategoryActivity.this, "Added Successfully", Toast.LENGTH_SHORT).show();
                                newcategoryed.setText("");
                            }
                            else{
                                Toast.makeText(MedicalCategoryActivity.this, "UN Successfull", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
