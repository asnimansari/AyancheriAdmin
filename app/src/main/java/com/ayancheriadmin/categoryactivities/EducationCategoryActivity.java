...
public class EducationCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = CusUtils.getDatabase().getReference().child("Education");
                    ...
                    databaseReference.child(++current_category_count +"").setValue(buisnessCategory).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(EducationCategoryActivity.this, "Added Successfully", Toast.LENGTH_SHORT).show();
                                newcategoryed.setText("");
                            }
                            else{
                                Toast.makeText(EducationCategoryActivity.this, "UN Successfull", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
