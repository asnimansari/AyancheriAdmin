...
public class BuisnessCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buisness_category);
        ...
        databaseReference = CusUtils.getDatabase().getReference().child("Business");
                    ...
                    databaseReference.push().setValue(buisnessCategory).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(BuisnessCategoryActivity.this, "Added Successfully", Toast.LENGTH_SHORT).show();
                                newcategoryed.setText("");
                            }
                            else{
                                Toast.makeText(BuisnessCategoryActivity.this, "UN Successfull", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
